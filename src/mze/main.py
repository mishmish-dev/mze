...
@click.group()
@click.option(
    "--base-dir", default=str(DEFAULT_DB_DIR), help="Base directory for mze database"
)
@click.pass_context
...
@click.option(
    "--bin-dir", default=DEFAULT_BIN_DIR, help="Directory for the wrapper executable"
)
@click.pass_context
...
@click.option(
    ...
    help="Directory of the wrapper executable to remove",
)
@click.pass_context
...
@click.option(
    ...
    help="Base directory for the mze environment",
)
@click.option(
    "--bin-dir", default=DEFAULT_BIN_DIR, help="Directory for the wrapper executable"
)
